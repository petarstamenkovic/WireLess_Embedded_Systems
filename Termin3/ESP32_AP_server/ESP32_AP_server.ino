...
const char* ssid = "Stamenkovic";  // Enter SSID here
...
void handle_OnConnect() {
  ...
  server.send(200, "text/html", SendHTML(LEDstatus)); // SendHTML vraca string - pogledaj dole
}
...
// Da li ovo moze pametnije? -- Zelimo da html kod bude u posebnom fajlu
// ---> SPI Flash File System - deo memorije za formiranje file sistema
